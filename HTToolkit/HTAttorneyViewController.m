...
@interface HTAttorneyViewController ()

@end

@implementation HTAttorneyViewController
@synthesize entry;
...
- (void)viewDidLoad
{
    ...
    UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 280, 85)];
    UITextView *labelView = [[UITextView alloc] initWithFrame:CGRectMake(10, 10, 280, 50)];
    UILabel *detail = [[UILabel alloc] initWithFrame:CGRectMake(20, 60, 260, 25)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section == 0){
        ...
        UITextView *textview = [[UITextView alloc] initWithFrame:CGRectMake(0,0, 280, 90)];
        ...
        UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
        UITextView *textview = [[UITextView alloc] initWithFrame:CGRectMake(0,0, 280, 50)];
