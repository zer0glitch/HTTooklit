...
- (void)viewDidLoad
{
    ...
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General of Alabama" state:@"Alabama" district:nil contact: @"Luther Strange" summary:nil address:@"501 Washington Avenue\nMontgomery, AL 36104" website:@"http://www.ago.state.al.us/Page-Contact-Us" email: nil];
    [one addNumber:@"Phone: (334) 242-7300"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Civil Division Anchorage Office" state:@"Alaska" district:nil contact: @"Kamala Harris" summary:nil address:@"1031 W. 4th Avenue, Suite 200\nAnchorage, AK 99501-1994" website:@"http://www.law.state.ak.us/department/contact.html" email:@"attorney.general@alaska.gov"];
    [one addNumber:@"Phone: (907) 465-2133"];
    [one addNumber:@"Fax:(907) 465-2075"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Phoenix Office of Attorney" state:@"Arizona" district:nil contact: @"Tom Horne" summary:nil address:@"1275 West Washington Street\nPhoenix, AZ 85007-2926" website:@"https://www.azag.gov/contact-us" email:@"consumerinfo@azag.gov"];
    [one addNumber:@"Phone: (602) 542-5025"];
    [one addNumber:@"Fax:(602) 542-4085"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General's Office of Arkansas" state:@"Arkansas" district:nil contact: @"Dustin McDaniel" summary:nil address:@"323 Center Street, Suite 200\nLittle Rock AR 72201" website:@"http://www.ag.arkansas.gov/contact-us/" email: nil];
    [one addNumber:@"Phone: (501) 682-2007"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Public Inquiry Unit" state:@"California" district:nil contact: @"Kamala Harris" summary:nil address:@"P.O. Box 944255\nSacramento, CA 94244-2550" website:@"http://oag.ca.gov/contact" email: nil];
    [one addNumber:@"Phone: (916) 445-9555"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General of Colorado" state:@"Colorado" district:nil contact: @"John Suthers" summary:nil address:@"1300 Broadway, 10th Floor\nDenver, CO 80203" website:@"http://www.coloradoattorneygeneral.gov/contact_us" email:@"attorney.general@state.co.us"];
    [one addNumber:@"Phone: (720) 508-6000"];
    [one addNumber:@"Fax:(720) 508-6030"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General Office Of Connecticut" state:@"Connecticut" district:nil contact: @"George Jepsen" summary:nil address:@"55 Elm St.\n Hartford, CT 06106" website:@"http://www.phone.ct.gov/ContactsForAgency.aspx?deptid=OAG" email: nil];
    [one addNumber:@"Phone: (860) 808-5318"];
    [one addNumber:@"Fax:(860) 808-5387"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Wilmington Office" state:@"Delaware" district:nil contact: @"Beau Biden" summary:nil address:@"820 N. French Street\nWilmington, DE 19801 " website:@"http://attorneygeneral.delaware.gov/office/contact.shtml" email:@"Attorney.General@State.DE.US"];
    [one addNumber:@"Phone: Civilian Division (302) 577-8400"];
    [one addNumber:@"Fax:(302) 577-6630"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Administrative Services-Tallahassee Office" state:@"Florida" district:nil contact: @"Pam Bondi" summary:nil address:@"The Capitol PL-01\nTallahassee, FL 32399-1050" website:@"http://www.myfloridalegal.com/contact" email: nil];
    [one addNumber:@"Phone: (850) 414-3300"];
    [one addNumber:@"Fax:(850) 488-5106"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Department of the Attorney General" state:@"Georgia" district:nil contact: @"Sam Olens" summary:nil address:@"40 Capitol Square, SW\nAtlanta, Ga 30334" website:@"http://law.ga.gov/contact-us-0" email:@"AGOlens@law.ga.gov"];
    [one addNumber:@"Phone: (404) 656-3300"];
    [one addNumber:@"Fax:(404) 657-8733"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Department of the Attorney General of Hawaii" state:@"Hawaii" district:nil contact: @"David M. Louie" summary:nil address:@"425 Queen Street\nHonolulu, HI 96813 " website:@"http://ag.hawaii.gov/contact-us/" email: nil];
    [one addNumber:@"Phone: (808) 586-1500"];
    [one addNumber:@"Fax:(808) 586-1239"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General of Idaho" state:@"Idaho" district:nil contact: @"Lawrence G. Wasden" summary:nil address:@"700 W. Jefferson Street, Suite 210 P.O. Box 83720\nBoise, Idaho 83720-0010" website:@"http://www.ag.idaho.gov/aboutUs/contactUs.html" email: nil];
    [one addNumber:@"Phone: (208) 334-2400"];
    [one addNumber:@"Fax:(208) 854-8071"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Chicago Main Office" state:@"Illinois" district:nil contact: @"Lisa Madigan" summary:nil address:@"100 West Randolph Street\nChicago, IL 60601 " website:@"http://illinoisattorneygeneral.gov/about/oagdirectory.html" email: nil];
    [one addNumber:@"Phone: (312) 814-3000"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General's Office" state:@"Indiana" district:nil contact: @"Greg Zoeller" summary:nil address:@"302 W. Washington St., 5th Floor\nIndianapolis, IN 46204" website:@"http://www.in.gov/attorneygeneral/2353.htm" email:@"Constituent@atg.in.gov"];
    [one addNumber:@"Phone: (317) 232-6201"];
    [one addNumber:@"Fax:(317) 232-7979"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Iowa Attorney General Office" state:@"Iowa" district:nil contact: @"Tom Miller" summary:nil address:@"1305 E. Walnut Street\nDes Moines IA 50319 " website:@"http://www.iowaattorneygeneral.org/contact_us/index.html" email:@"webteam@ag.state.ia.us"];
    [one addNumber:@"Phone: (515) 281-5164"];
    [one addNumber:@"Fax:(515) 281-4209"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Kansas Attorney General Office" state:@"Kansas" district:nil contact: @"Derek Schmidt" summary:nil address:@"120 SW 10th Ave., 2nd Floor\nTopeka, KS 66612" website:@"http://ag.ks.gov/about-the-office/contact-us/contact-us" email: nil];
    [one addNumber:@"Phone: (785) 296-2215"];
    [one addNumber:@"Fax:(785) 296-6296"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Louisville Branch Office" state:@"Kentucky" district:nil contact: @"Jack Conway" summary:nil address:@"700 Capitol Avenue, Suite 118\nFrankfort, Kentucky 40601" website:@"http://ag.ky.gov/Pages/default.aspx" email: nil];
    [one addNumber:@"Phone: (502) 429-7134"];
    [one addNumber:@"Fax:(502) 429-7129"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Administrative Services Division" state:@"Louisiana" district:nil contact: @"James Caldwell" summary:nil address:@"1885 N. Third Street\nBaton Rouge, LA 70802 " website:@"http://www.ag.state.la.us/Article.aspx?articleID=28&catID=0" email:@"AdminInfo@ag.state.la.us"];
    [one addNumber:@"Phone: (225) 326-6705"];
    [one addNumber:@"Fax:(225) 326-6793"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Maine Attorney General" state:@"Maine" district:nil contact: @"Janet Mills" summary:nil address:@"6 State House Station\n Augusta, ME 04333 " website:@"http://www.maine.gov/ag/contact.html" email: nil];
    [one addNumber:@"Phone: (207) 626-8800"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General of Maryland" state:@"Maryland" district:nil contact: @"Douglas Gansler" summary:nil address:@"200 St. Paul Place\nBaltimore, MD 21202 " website:@"http://www.oag.state.md.us/contact.htm" email:@"consumer@oag.state.md.us"];
    [one addNumber:@"Phone: (410) 576-6300"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Springfield Office" state:@"Massachusetts" district:nil contact: @"Martha Coakley" summary:nil address:@"1350 Main Street, Fourth Floor\nSpringfield, MA 01103-1629" website:@"http://www.mass.gov/ago/contact-us.html" email: nil];
    [one addNumber:@"Phone: (413) 784-1240"];
    [one addNumber:@"Fax:(413) 784-1244"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Lansing Office" state:@"Michigan" district:nil contact: @"Bill Schuette" summary:nil address:@"G. Mennen Williams Building, 7th Floor 525 W. Ottawa St.P.O. Box 30212\nLansing, MI 48909" website:@"http://www.michigan.gov/ag/0,4534,7-164-21153-51368--,00.html" email: nil];
    [one addNumber:@"Phone: (517) 373-1110"];
    [one addNumber:@"Fax:(517) 373-3042"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of Minnesota Attorney General Lori Swanson" state:@"Minnesota" district:nil contact: @"Lori Swanson" summary:nil address:@"1400 Bremer Tower 445 Minnesota Street\nSt. Paul, MN 55101" website:@"http://www.ag.state.mn.us/Office/ContactUs.asp" email: nil];
    [one addNumber:@"Phone: (651) 296-3353"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"MS Attorney General's Office Walter Sillers Building" state:@"Mississippi" district:nil contact: @"Jim Hood" summary:nil address:@"Walter Sillers Building 550 High Street, Suite 1200\nJackson, MS 39201" website:@"http://agjimhood.com/index.php/contact" email: nil];
    [one addNumber:@"Phone: (601) 359-3680"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Jefferson Office" state:@"Missouri" district:nil contact: @"Chris Koster" summary:nil address:@"207 W. High St. P.O. Box 899\nJefferson City, MO 65102" website:@"http://ago.mo.gov/contactus.htm" email:@"attorney.general@ago.mo.gov"];
    [one addNumber:@"Phone: (573) 751-3321"];
    [one addNumber:@"Fax:(573) 751-0774"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Department of Justice and Attorney General" state:@"Montana" district:nil contact: @"Tim Fox" summary:nil address:@"P.O. Box 201401\nHelena, MT 59620-1401" website:@"https://doj.mt.gov/about/contact-us/" email:@"contactdoj@mt.gov"];
    [one addNumber:@"Phone: (406) 444-2026"];
    [one addNumber:@"Fax:(406) 444-3549"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General" state:@"Nebraska" district:nil contact: @"Jon Bruning" summary:nil address:@"2115 State Capitol\nLincoln, NE 68509" website:@"http://www.ago.ne.gov/contact" email:@"ago.consumer@nebraska.gov"];
    [one addNumber:@"Phone: (402) 471-2682"];
    [one addNumber:@"Fax:(402) 471-3297"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Carson City Office" state:@"Nevada" district:nil contact: @"Catherine Cortez" summary:nil address:@"100 North Carson Street\nCarson City, NV 89701" website:@"http://ag.nv.gov/Contact/Contact/" email: nil];
    [one addNumber:@"Phone: (775) 684-1100"];
    [one addNumber:@"Fax:(775) 684-1108"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"NH Department of Justice" state:@"New Hampshire" district:nil contact: @"Joseph Foster" summary:nil address:@"33 Capitol Street\nConcord, NH 03301" website:@"http://doj.nh.gov/contact-us/index.htm" email: nil];
    [one addNumber:@"Phone: (603) 271-3658"];
    [one addNumber:@"Fax:(603) 271-2110"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Trenton Regional Office" state:@"New Jersey" district:nil contact: @"John Hoffman" summary:nil address:@"140 East Front Street, 6th Floor\nTrenton, NJ 08625-0090 " website:@"http://www.nj.gov/oag/contactus.htm" email: nil];
    [one addNumber:@"Phone: (609) 292-4925"];
    [one addNumber:@"Fax:(609) 292-3508"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Santa Fe Office" state:@"New Mexico" district:nil contact: @"Gary King" summary:nil address:@"408 Galisteo Street Villagra Building\nSanta Fe, NM 87501" website:@"http://www.nmag.gov/contact-us" email:@"psisneros@nmag.gov"];
    [one addNumber:@"Phone: (505) 827-6000"];
    [one addNumber:@"Fax:(505) 827-5826"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General" state:@"New York" district:nil contact: @"Eric Schneiderman" summary:nil address:@"The Capitol\nAlbany, NY 12224-0341" website:@"http://www.ag.ny.gov/contact-attorney-general" email: nil];
    [one addNumber:@"Phone: (800) 771-7755"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General Office" state:@"North Carolina" district:nil contact: @"Roy Cooper" summary:nil address:@"9001 Mail Service Center\nRaleigh, NC 27699-9001" website:@"http://www.ncdoj.gov/getdoc/714fcea5-4eb0-4558-801d-c12c39bb30c8/DOJ-Contact-Information.aspx" email: nil];
    [one addNumber:@"Phone: (919) 716-6400"];
    [one addNumber:@"Fax:(919) 716-6750"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General's Office" state:@"North Dakota" district:nil contact: @"Wayne Stenehjem" summary:nil address:@"600 E. Boulevard Ave. Dept. 125\nBismarck, ND 58505" website:@"http://www.ag.state.nd.us/About/ContactUs.htm" email:@"ndag@nd.gov"];
    [one addNumber:@"Phone: (701) 328-2210"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General's Office Help Center" state:@"Ohio" district:nil contact: @"Mike DeWine" summary:nil address:@"30 E. Broad St., 14th Floor\nColumbus, OH 43215" website:@"http://www.ohioattorneygeneral.gov/Contact" email: nil];
    [one addNumber:@"Phone: (800) 282-0515"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of Attorney General" state:@"Oklahoma" district:nil contact: @"Scott Pruit" summary:nil address:@"313 NE 21st Street,\n Oklahoma City, OK 73105" website:@"http://www.oag.state.ok.us/oagweb.nsf/" email: nil];
    [one addNumber:@"Phone: (405) 521-3921"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General's Office" state:@"Oregon" district:nil contact: @"Ellen Rosenblum" summary:nil address:@"1162 Court Street NE Salem,\n OR 97301-4096 " website:@"http://www.doj.state.or.us/Pages/contact.aspx" email:@"help@oregonconsumer.gov"];
    [one addNumber:@"Phone: (503) 378-4400"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of Attorney General" state:@"Pennsylvania" district:nil contact: @"Kathleen kane" summary:nil address:@"16th Floor, Strawberry Square\nHarrisburg, PA 17120" website:@"http://www.attorneygeneral.gov/theoffice.aspx?id=71" email: nil];
    [one addNumber:@"Phone: (717) 787-3391"];
    [one addNumber:@"Fax:(717)-787-8242"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Kent County Courthouse Office" state:@"Rhode Island" district:nil contact: @"Peter Kilmartein" summary:nil address:@"James W. Leighton Judicial Complex222 Quaker LaneWarwick,\n Rhode Island 02886" website:@"http://www.riag.ri.gov/contact/" email:@"contactus@riag.ri.gov"];
    [one addNumber:@"Phone: (401) 822-2710"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Rembert Dennis Building" state:@"South Carolina" district:nil contact: @"Alana Wilson" summary:nil address:@"1000 Assembly Street, Room 519\nColumbia, S.C. 29201" website:@"http://www.scag.gov/contact-us" email: nil];
    [one addNumber:@"Phone: (803) 734-3970"];
    [one addNumber:@"Fax:(803) 253-6283"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General" state:@"South Dakota" district:nil contact: @"Martey Jackley" summary:nil address:@"1302 E Hwy 14 Suite 1\nPierre SD 57501-8501 " website:@"http://atg.sd.gov/TheOffice/ContactUs.aspx" email: nil];
    [one addNumber:@"Phone: (605) 773-3215"];
    [one addNumber:@"Fax:(605) 773-4106"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General and Reporter" state:@"Tennessee" district:nil contact: @"Robert E. Cooper,Jr" summary:nil address:@"P.O. Box 20207\nNashville, TN 37202-0207" website:@"http://www.tn.gov/attorneygeneral/contact.html" email: nil];
    [one addNumber:@"Phone: (615) 741-3491"];
    [one addNumber:@"Fax:(615) 741-2009"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General" state:@"Texas" district:nil contact: @"Greg Abbott" summary:nil address:@"300 W. 15th Street\nAustin, TX 78701" website:@"https://www.oag.state.tx.us/agency/contacts.shtml" email:@"publicrecords@texasattorneygeneral.gov"];
    [one addNumber:@"Phone: (512) 463-2100"];
    [one addNumber:@"Fax:(512) 475-2994"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Utah State Capitol Office" state:@"Utah" district:nil contact: @"John Swallow" summary:nil address:@"Utah State Capitol Complex\n350 North State Street Suite 230" website:@"http://attorneygeneral.utah.gov/contact_us.html" email:@"uag@utah.gov"];
    [one addNumber:@"Phone: (801) 366-0260"];
    [one addNumber:@"Fax:(801) 538-1121"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the AttorneyGeneral" state:@"Vermont" district:nil contact: @"William Sorrell" summary:nil address:@"109 State Street\nMontpelier, VT 05609-1001" website:@"http://www.atg.state.vt.us/office-organization-information/contacting-us.php" email:@"atginfo@atg.state.vt.us"];
    [one addNumber:@"Phone: (802) 828-3171"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General" state:@"Virginia" district:nil contact: @"Ken Cuccinelli" summary:nil address:@"900 East Main Street\nRichmond, VA 23219" website:@"http://www.oag.state.va.us/Contact%20Us/contact_directory.html" email: nil];
    [one addNumber:@"Phone: (804) 786-2071"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General's Office" state:@"Washington" district:nil contact: @"Bob Ferguson" summary:nil address:@"PO Box 40100\nOlympia, WA  98504-0100" website:@"http://www.atg.wa.gov/ContactUs.aspx#Online" email: nil];
    [one addNumber:@"Phone: (360) 753-6200"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Main Office Administration" state:@"West Virginia" district:nil contact: @"Patrick Morrisey" summary:nil address:@"Bldg. 1, Room E-26\nCharleston, WV 25305" website:@"http://www.wvago.gov/contactus.cfm" email: nil];
    [one addNumber:@"Phone: (304) 558-2021"];
    [one addNumber:@"Fax:(304) 558-0140"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Wisconsin Department of Justice" state:@"Wisconsin" district:nil contact: @"J.B. VanHollen" summary:nil address:@"P.O. Box 7857\nMadison, WI 53707-7857" website:@"http://www.doj.state.wi.us/frequently-asked-questions" email: nil];
    [one addNumber:@"Phone: "];
    [one addNumber:@"Fax:(608) 267-2779"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General's Office" state:@"Wyoming" district:nil contact: @"Gregory A. Philips" summary:nil address:@"123 Capitol Building 200 W. 24th Street\nCheyenne, WY 82002 " website:@"http://attorneygeneral.state.wy.us/" email: nil];
