...
- (void)viewDidLoad
{
    ...
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Lansing Office" state:@"Michigan" district:nil contact: @"Bill Schuette" summary:nil address:@"G. Mennen Williams Building, 7th Floor\n525 W. Ottawa St.\nP.O. Box 30212\nLansing, MI 48909" website:@"http://www.michigan.gov/ag/0,4534,7-164-21153-51368--,00.html" email:nil];
    ...
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"MS Attorney General's Office Walter Sillers Building" state:@"Mississippi" district:nil contact: @"Jim Hood" summary:nil address:@"Walter Sillers Building\n550 High Street, Suite 1200\nJackson, MS 39201" website:@"http://agjimhood.com/index.php/contact" email:nil];
    ...
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Attorney General's Office" state:@"Oregon" district:nil contact: @"Ellen Rosenblum" summary:nil address:@"1162 Court Street NE\nSalem, OR 97301-4096 " website:@"http://www.doj.state.or.us/Pages/contact.aspx" email:@"help@oregonconsumer.gov"];
    ...
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Kent County Courthouse Office" state:@"Rhode Island" district:nil contact: @"Peter Kilmartein" summary:nil address:@"James W. Leighton Judicial Complex\n222 Quaker Lane\nWarwick, Rhode Island 02886" website:@"http://www.riag.ri.gov/contact/" email:@"contactus@riag.ri.gov"];
    [one addNumber:@"Phone: (401) 822-2710"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Rembert Dennis Building" state:@"South Carolina" district:nil contact: @"Alana Wilson" summary:nil address:@"1000 Assembly Street, Room 519\nColumbia, SC 29201" website:@"http://www.scag.gov/contact-us" email:nil];
    [one addNumber:@"Phone: (803) 734-3970"];
    [one addNumber:@"Fax: (803) 253-6283"];
    [attorneyGenerals addObject:one];
    one = [[HTAllianceData alloc]init:@"Office of the Attorney General" state:@"South Dakota" district:nil contact: @"Martey Jackley" summary:nil address:@"1302 E Hwy 14\nSuite 1\nPierre, SD 57501-8501 " website:@"http://atg.sd.gov/TheOffice/ContactUs.aspx" email:nil];
