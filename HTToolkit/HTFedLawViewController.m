...
- (void)viewDidLoad
{
    ...
    HTFedLawData *one = [[HTFedLawData alloc] init:@"78.7102 Definitions" summary: @"Provides definitions for terms relevant to human trafficking such as coersion, involuntary servitude, victim of trafficking, etc." link:@"http://www.gpo.gov/fdsys/pkg/USCODE-2011-title22/pdf/USCODE-2011-title22-chap78-sec7102.pdf"];
    [Laws addObject:one];
    ...
    [Laws addObject:one];
    one = [[HTFedLawData alloc] init:@"78.7105 Protection and assistance for victims of trafficking" summary: @"Extends protection and assitance to victims of trafficking both in the United States and in other countries." link:@"http://www.gpo.gov/fdsys/pkg/USCODE-2011-title22/pdf/USCODE-2011-title22-chap78-sec7105.pdf"];
    [Laws addObject:one];
    one = [[HTFedLawData alloc] init:@"78.7105a Increasing effectiveness of anti-trafficking programs" summary: @"Aims to increase the effectiveness of anti-trafficking programs by offering grants and contracts to programs deemed elegible by a given criteria." link:@"http://www.gpo.gov/fdsys/pkg/USCODE-2011-title22/pdf/USCODE-2011-title22-chap78-sec7105a.pdf"];
    [Laws addObject:one];
    one = [[HTFedLawData alloc] init:@"78.7106 Minimum standards for the elimination of trafficking" summary: @"Provides what is considered to be the minimum neccessary steps by the government of a country for it to be on it's way toward eliminating human trafficking." link:@"http://www.gpo.gov/fdsys/pkg/USCODE-2011-title22/pdf/USCODE-2011-title22-chap78-sec7106.pdf"];
    [Laws addObject:one];
