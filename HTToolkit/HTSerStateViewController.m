...
- (void)viewDidLoad
{
    ...
    [ser addNumber:@"Hotline: (888) 539-2373"];
    [data addObject:ser];
    ser = [[HTServiceData alloc] init:@"California" city:@"Los Angeles" gender:@"Child" agency:@"Coalition to Abolish Slavery and Trafficking (CAST)" address:@"http://www.castla.org" info:@"Works with the Los Angeles Metro Area Task Force on Human Trafficking. Provides social, legal and shelter services in one location, including physical and psychological health care, help in filing for T-Visas, and job training for victims of human trafficking."];
    [ser addNumber:@"Phone: (213) 365-1906"];
    [ser addNumber:@"Hotline: (888) 539-2373"];
    [data addObject:ser];
    ...
    ser = [[HTServiceData alloc] init:@"Texas" city:@"El Paso" gender:@"Family" agency:@"Sheffield Place" address:@"www.sheffieldplace.org" info:@"Sheffield Place serves homeless mothers with children ages 0-12 years.  The only requirements for admission are that a homeless mother has children in this age range, has a reunification plan, or is in her third trimester of pregnancy.  The mother must be clean from alcohol and drugs.  A mother who meets these criteria is encouraged to call Sheffield Place.  Her name will place on a waiting.  When her name comes to the top of the waiting list, she will be contacted to come to the facility to complete an application and participate in an interview.\nResidential Services - provides a two room living unit with a private bath and a shared kitchen and laundry facilities on each of the three floors of the shelter facility."];
    [ser addNumber:@"Phone: (816) 483-9927"];
    [data addObject:ser];
